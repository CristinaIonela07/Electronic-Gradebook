...
public class DateTeacher {
    JFrame frame = new JFrame("Teacher_Name");
    JButton next;
    JLabel lname;
    JTextField name;
    public DateTeacher(ScoreVisitor scoreVisitor){
            ...
            ActionListener al = new ActionListener() {
                ...
                public void actionPerformed(ActionEvent e) {
                    ...
                    for (Course course : Catalog.getInstance().getCourses()) {
                        if ((course.getTeacher().toString()).equals(teacher_name)) {
                            new TeacherPage(course.getTeacher(), scoreVisitor);
                            break;
                        }
                    }
                }
